...
ผลตรวจล่าสุด: **51 integration tests และ 16 browser tests ผ่าน** ดู [ผลตรวจ v0.7](docs/19-financial-events.md), [ผลตรวจ v0.6](docs/18-source-line-deduplication.md) หรือ [Business Logic verification](docs/15-business-logic-verification.md)

...
สถานะ ณ 2026-09-16: มี **local foundation และ generic order-line vertical slice** แล้ว ดู [ผลส่งมอบ v0.4](14-confirmed-orders-and-contribution.md) FND-01/02/03, CAT-01, AI-01 และ QA-01 เริ่มมีโค้ดและการทดสอบ IMP-01/02/03/04 และ FIN/UI มีเพียงบางส่วนที่ระบุใน v0.4 ยังไม่ครบ production acceptance โดยเฉพาะ raw storage, marketplace adapters, corrections, settlement/refund/ads, identity provider, backup/restore และ live model evaluation

## ลำดับ dependency

อัปเดต v0.4: generic CSV รองรับ mapping/review/commit แบบ idempotent, snapshot ต้นทุน, summary/evidence และ RLS แล้ว ยังไม่ใช่ import worker, marketplace adapter หรือ financial acceptance ครบชุด ดู [ผลส่งมอบ](14-confirmed-orders-and-contribution.md)
